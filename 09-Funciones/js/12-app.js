...
// # 67. Arrow Functions en un forEach y un map

// * Extraemos el código de la siguiente sección y lo modificamos con arrows functions
...
// const nuevoArreglo = carrito.map( p => {
...
const nuevoArreglo = carrito.map( p => `Nombre: ${p.nombre}, Precio: ${p.precio}`);

const nuevoArreglo2 = carrito.forEach( p => console.log(`Nombre: ${p.nombre}, Precio: ${p.precio}`) );
