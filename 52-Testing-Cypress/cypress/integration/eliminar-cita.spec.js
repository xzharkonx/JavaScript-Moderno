...
describe('Llena los campos para una nueva cita y la elimina', () => {
    ...
    // ? Agregamos un test
    it('Llenar campos de formulario para una nueva cita', () => {
    ...
    // ### Otro test para eliminar la Cita

    it('Eliminar una Cita', () => {

        // ? Primero agregaremos los data-cy a los elementos que queremos revisar.
        // ? Buscamos en UI.js al botón de editar que se agrega al DOM.
        ...
        // * Crear un screenshot una vez llegada a esta parte.
        // ? Nos creará una imágen (screenshot de la pantalla) 
        // ? del test en la parte que ejecutemos esta función
        // ? Podemos buscarla en los archivos de la carpeta cypress
        cy.screenshot();
    });
});
